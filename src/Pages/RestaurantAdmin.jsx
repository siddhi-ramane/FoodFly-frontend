...
const data = async ()=>{
try {
    const resss =  await axios.get("https://foodfly-backend-11.onrender.com/cuisine/getcusine");
...
useEffect(()=>{
 ...
 const submitdata={...form,
      ...
      await axios.post("https://foodfly-backend-11.onrender.com/menu/add/items",
         submitdata,
          {
