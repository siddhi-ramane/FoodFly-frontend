...
const MenuItem = () => {
 ...
 const [data, setData] = useState([]);
  ...
  //     try {
  //       const response = await axios.get("https://foodfly-backend-9.onrender.com/menuItems/get");
  ...
  const pagedata = async () => {
    try {
      const res = await axios.get(
        `https://foodfly-backend-9.onrender.com/menuItems/get?page=${page}&size=${size}`
      );
