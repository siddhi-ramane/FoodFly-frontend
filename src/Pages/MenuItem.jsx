...
const [menuData, setMenuData] = useState([]); 
  ...
  //     try {
  //       const response = await axios.get("https://foodfly-backend-111.onrender.com/api/menuItems/get");
  ...
  const pagedata = async () => {
    try {
      const res = await axios.get(
        `https://foodfly-backend-111.onrender.com/api/menuItems/get?page=${page}&size=${size}`
      );
