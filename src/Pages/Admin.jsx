...
const Admin = () => {
  ...
  useEffect(() => {
    const getMenu = async () => {
      if (select === "menulist") {
        try {
          const response = await axios.get("https://foodfly-backend-11.onrender.com/menu/get");
...
// }
  ...
  const Patchhandle =  async (id)=>{
        try {
           await axios.patch(`https://foodfly-backend-11.onrender.com/menu/${id}/approve`,
           {
            isApproved: "true"
           },
 ...
 const deletehandlee =  async (id)=>{
        try {
           await axios.delete(`https://foodfly-backend-11.onrender.com/menu/${id}/delete`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
     await axios.post(
        "https://foodfly-backend-11.onrender.com/Role/add",
        {
